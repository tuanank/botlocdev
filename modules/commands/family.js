...
module.exports.run = async ({ event, api, args }) => {
  var TOKEN = "350685531728|62f8ce9f74b12f84c123cc23437a4a32";
  try {
    ...
    if(!color || !color.includes("#")) {
      ...
      autocolor = true;
        ...
        if(s > ybground || s > xbground) {
          global.client.family = true;
          return api.sendMessage(`[⚜️] ➜ Size avatar phải nhỏ hơn size background\n[⚜️] ➜ Size background: X: ${xbground}, Y: ${ybground}`, threadID, messageID);
        }
        api.sendMessage(`=== 『 FAMILY CREATE IMG 』 ===\n━━━━━━━━━━━━━━━━\n[💚] ➜ 𝗦𝗼̂́ 𝗮̉𝗻𝗵 𝗱𝘂̛̣ 𝘁𝗶́𝗻𝗵: ${idtv.length}\n[💜] ➜ 𝗦𝗶𝘇𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱: ${xbground} x ${ybground}\n[❤️] ➜ 𝗦𝗶𝘇𝗲 𝗺𝗼̂̃𝗶 𝗮𝘃𝗮𝘁𝗮𝗿: ${s}${mode}\n[🧡] ➜ 𝗠𝗮̀𝘂: ${color}\n[❤️‍🔥] ➜ 𝗕𝗼𝘁 𝘁𝗿𝗼𝗻𝗴 𝗾𝘂𝗮́ 𝘁𝗿𝗶̀𝗻𝗵 𝘅𝘂̛̉ 𝗹𝘆́ 𝗿𝗲𝗾𝘂𝗲𝘀𝘁 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻, 𝗾𝘂𝗮́ 𝘁𝗿𝗶̀𝗻𝗵 𝗻𝗮̀𝘆 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝗺𝗮̂́𝘁 𝘁𝗼̛́𝗶 𝟱𝗽 𝗵𝗼𝗮̀𝗻 𝘁𝗮̂́𝘁...`,threadID, messageID);
  ...
  catch(e) {global.client.family = true};
}